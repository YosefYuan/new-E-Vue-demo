        ...
        <div class="sales-board-form">
            <div class="sales-board-line">
                ...
                <div class="sales-board-line-right">
                    <v-counter :max="100" :min="20" @on-change="paramsChange('buyNum',$event)"></v-counter>
                </div>
            </div>
            <div class="sales-board-line">
                <div class="sales-board-line-left">
                ...
                <div class="sales-board-line-right">
                    <v-mul-chooser :selections="versionList" @on-change="paramsChange('mediaType',$event)"></v-mul-chooser>
                </div>
            </div>
            <div class="sales-board-line">
                <div class="sales-board-line-left">
...
export default {
    ...
    methods: {
        paramsChange(attr, val) {
            this[attr] = val
            // console.log(attr, this[attr])
            this.getPrice()
        },
        getPrice() {
            let mediaArray = _.map(this.mediaType, (item) => {
                return item.value
            })
            let params = {
                buyNum: this.buyNum,
                media: mediaArray.join(',')
            }
    ...
    mounted() {
        this.buyNum = 20,
            this.mediaArray = [this.versionList[0]]
        this.getPrice()
    },
    data() {
        return {
